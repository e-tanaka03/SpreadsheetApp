...
// CSVファイルへのパス
csv.open("GET", "Csv/SyukeiD1.csv", false);
...
csv_sum.open("GET", "Csv/SyukeiD1a.csv", false);
            ...
            if( j == 0 || csvArray[i][j] == "" || j > 6 ){
              if( j == csvArray[i].length - 1 ){
                ...
                if( csvArray[i][2] != "" ){
                  ...
                  a.href = "https://paradiso-ssl.xsrv.jp/WebData/ShopkD1.html?ShopNum=" + csvArray[i][1];
                  tdj.appendChild(a);
                }
                else{
                  tdj.textContent = csvArray[i][j];
