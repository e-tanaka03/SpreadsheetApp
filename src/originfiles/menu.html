...
<body>
<header><a id="header" href="menu.html">Spreadsheet App</a></header>

<h1>全店舗集計</h1>
<div class="bottom-space top-space">
   <a class="button" href="./SyukeiD0.html">本日データ</a>
   <a class="button" href="./SyukeiD1.html">前日データ</a>
</div>
...
<script src="js/menu.js?20240603"></script>
